      ...
      <div className="px-4 py-4">
        ...
        <div className="space-y-3">
          {loading ? (
            ...
            <div
              key={i}
              className="flex gap-3 p-4 rounded-2xl animate-fade-up"
              style={{ background: 'white', border: '1px solid var(--line)', animationDelay: `${i * 0.08}s`, opacity: 0 }}
            >
              ...
              <div className="flex-1 min-w-0">
                <div className="flex items-start justify-between gap-2">
                  ...
                  <div
                    ...
                    style={{ background: 'rgba(30,77,58,0.1)', color: 'var(--forest)' }}
                  >
                    {s.matchScore}
                  </div>
                </div>
                {s.genre && (
                  <span className="inline-block mt-1 px-2 py-0.5 rounded-full text-[10px] font-medium" style={{ background: 'var(--cream-2)', color: 'var(--muted)' }}>
                    {s.genre}
                  </span>
                )}
